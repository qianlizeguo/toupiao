 ...
 <select name="moban" >
  ...
  <option value="4" <?php if(($vo["moban"]) == "4"): ?>selected<?php endif; ?>>模版四[淡蓝系]</option>
   <option value="5" <?php if(($vo["moban"]) == "5"): ?>selected<?php endif; ?>>模版五[土豪金]</option>
    <option value="6" <?php if(($vo["moban"]) == "6"): ?>selected<?php endif; ?>>模版六[黄色系]</option>
    ...
    <option value="9" <?php if(($vo["moban"]) == "9"): ?>selected<?php endif; ?>>模版九[黑黄系]</option>
    <option value="10" <?php if(($vo["moban"]) == "10"): ?>selected<?php endif; ?>>模版十[新年红]</option>
     <option value="11" <?php if(($vo["moban"]) == "11"): ?>selected<?php endif; ?>>模版十一[深青系]</option>
</select>
