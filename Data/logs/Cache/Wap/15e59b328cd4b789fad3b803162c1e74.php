    ...
    <div class="apply">
        ...
        <form action="" id="signupok" method="post" accept-charset="utf-8">
		 ...
		 <input type="hidden" name="token" value="<?php echo ($token); ?>" />
            ...
            <div style="color: #EC6941;font-size: 16px;padding: 0 15px 15px 15px; line-height:24px; font-weight:bolder;"><?php echo ($vote['wfbmbz']); ?></div> <!-- 无法报名说明 -->
                        <div class="btn_box">
...
<?php elseif($bmzt == 3): ?>
    <div class="pop" id="guanzhu" style="display:block">
        ...
        <div class="pop_up">
            ...
            <p class="tit_txt"><?php echo ($vote["ydgzts"]); ?></p>
            <a href="<?php echo ($vote["wxgzurl"]); ?>" class="gz_btn"><?php echo ($user["ydgzan"]); ?></a>
        </div>
    </div>
	<?php else: endif; ?>
</section>
